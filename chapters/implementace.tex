...
Flask aplikace je dále rozdělena na tzv. \uv{blueprinty} (v MVC návrhovém vzoru prezenter), kde každý reprezentuje jeden HTTP API koncový bod (ukázka kódu \ref{code:piper-core-blueprint}).
...
Implementace tzv. \uv{streaming logu} je 
