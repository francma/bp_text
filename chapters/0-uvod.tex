...
Mnoho CI systémů implementuje tzv. \uv{straming logy}, což znamená, že výstup z příkazů je dostupný v \uv{realném čase} místo nutnosti čekat na doběhnutí integrace.