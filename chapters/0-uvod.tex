...
Mnoho CI systémů implementuje tzv. \uv{streaming logy}, což znamená, že výstup z příkazů je dostupný v \uv{realném čase} místo nutnosti čekat na doběhnutí celé integrace.
