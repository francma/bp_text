...
Autentizace uživatele do systému přes terminálové rozhraní je vyřešeno pomocí klient-server SSH protokolu, konkrétně autentizace založené na asymetrickém klíči.
