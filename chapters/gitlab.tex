...
Cesta k~souboru je uvedená jako relativní ke kořeni projektu, cachování souborů mimo projekt není touto cestou možné. % prapodivna veta 
...
Místo toho lze využít neoficiálních aplikací, které vytváří terminálovou \uv{obálku} nad již zmíněným REST API.
